...
if user_exist(user_name):
    ...
    length = saved_length
    print(f"Добро пожаловать, {user_name}! Продолжаем с уровня: {level_num}, длиной: {length}, счет: {score}")
...
class Level():
    def __init__(self, level_num):
        self.blocks = []
        self.block_img = pygame.transform.scale(pygame.image.load('wall.jpg'), (60, 60))
...
def game_over():
    ...
    screen.blit(font_large.render("GAME OVER", True, pygame.Color('orange')), (WIDTH // 2 - 100, HEIGHT // 3))
    pygame.display.flip()
...
snake_head_img = pygame.transform.scale(pygame.image.load('snake_head.jpg'), (40, 40))
snake_body_img = pygame.transform.scale(pygame.image.load('snake_body.jpg'), (40, 40))
# Картинки для еды
food_img = pygame.transform.scale(pygame.image.load('food.png'), (40, 40))
superfood_img = pygame.transform.scale(pygame.image.load('super_food.jpg'), (40, 40))
paused = False
